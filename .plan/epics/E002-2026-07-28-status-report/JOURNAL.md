...
- Owner requested a vision-first homepage. Reordered the root to Vision/Mission, timeline, pre-order rationale, product direction, Current state and roadmap; removed the failure summary from the homepage while retaining it in the update article. Added WHO-sourced 31% / 1.8 billion context and clarified that 200 means upfront pre-order customers.
